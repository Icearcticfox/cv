...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      {AiTi}{Moscow}
      \resumeItemListStart
        \resumeItem{As part of a team that developed an electronic document management system for Aeroflot, intended to replace the outdated IBM Lotus Notes/Domino. I was responsible for updating documentation, performing manual testing, tracking bugs, and training customer support staff.}
      \resumeItemListEnd
