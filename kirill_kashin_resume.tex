...
\begin{center}
    ...
    \small +357-999-64-268 $|$ \href{mailto:kirillkashin@yahoo.com}{\underline{kirillkashin@yahoo.com}} $|$ 
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Criteo}{August 2023 -- Present}
      {Limassol}{Cyprus}
      \resumeItemListStart
        \resumeItem{Observability team}
          {Supporting monitoring stack based on Prometheus, VictoriaMetrics, OpenTelemetry, Grafana, Tempo etc}
        \resumeItem{Volt installation, Secret management, GCP, Terrafor, etc}
        \resumeItem{Prometheus installation, support}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Deploy process / Delivery}{: Gitlab, Teamcity } \\
     \textbf{Infrastructure}{: Kubernetes, Helm, Kustomize, Terrafor } \\
     \textbf{Practice}{: Incident management, Postmortems } \\
    }}
 \end{itemize}
